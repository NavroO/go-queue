...
const (
	MessageService_SendMessage_FullMethodName    = "/queue.MessageService/SendMessage"
	MessageService_ReceiveMessage_FullMethodName = "/queue.MessageService/ReceiveMessage"
	MessageService_AckMessage_FullMethodName     = "/queue.MessageService/AckMessage"
)
...
func (c *messageServiceClient) ReceiveMessage(ctx context.Context, in *ReceiveMessageRequest, opts ...grpc.CallOption) (*ReceiveMessageResponse, error) {
	...
	err := c.cc.Invoke(ctx, MessageService_ReceiveMessage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MessageService_ReceiveMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MessageService_ReceiveMessage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var MessageService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "queue.MessageService",
